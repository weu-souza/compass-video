...
const addLater = (sessionId: string, mediaId: number, mediaType: 'tv' | 'movie'): Promise<AxiosResponse<any>> => {
  const options = {
    method: 'POST',
    url: `https://api.themoviedb.org/3/account/21349506/watchlist`,
    ...
    data: { media_id: mediaId, media_type: mediaType, watchlist: true }
  };

...
const Favorite = ({media_type,media_id}:favBtn) => {
  const [active, setActive] = useState(false);
    ...
    useEffect(() => {
      ...
      if (sessionId) {
        fetchList(`https://api.themoviedb.org/3/account/${import.meta.env.VITE_account_id}/favorite/movies`, setFilmesVerDepois);
      fetchList(`https://api.themoviedb.org/3/account/${import.meta.env.VITE_account_id}/favorite/tv`, setSeriesVerDepois);
      } else {
    ...
    const watchlistOptions = {
      method: "POST",
      url: `https://api.themoviedb.org/3/account/${import.meta.env.VITE_account_id}/favorite`,
